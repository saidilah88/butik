            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="add_pelanggan_form.php" class="btn btn-primary">
              ...
              <div class="card-body">
                <table class="table table-bordered table-hover">
					...
					<?php
					// menuliskan query mengambil data
					$no = 1;
					...
					while($data = $q->fetch_assoc()){ ?>
						<tr>
							...
							<td> 
							<a href="edit_pelanggan_form.php?id_pelanggan=<?php echo $data['id_pelanggan']?>" class="btn btn-sm btn-warning">
								<i class="fas fa-edit mr-1"></i>Ubah</a>
								<a href="delete_pelanggan_action.php?id_pelanggan=<?php echo $data['id_pelanggan']?>" 
									class="btn btn-sm btn-danger" onclick="return confirm('Anda Yakin Ingin Menghapus?')">
