        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Input Data Pelangggan</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card">
              ...
              <div class="card-body">
			  <form method="POST" action="add_pelanggan_action.php">
				<div class="form-grup">
				...
				<div class="form-grup">
					<input type="submit" class="btn btn-primary"
						value="Simpan">
					<a href="pelanggan_list.php" class="btn btn-danger">
						Kembali
					</a>
				</div>
			  </form>
