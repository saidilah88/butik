          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <a href="add_produk_form.php" class="btn btn-primary">
...
<td>
<a href="edit_produk_form.php?id_produk=<?php echo $data['id_produk']?>" class="btn btn-sm btn-warning">
								<i class="fas fa-edit mr-1"></i>Ubah</a>
								<a href="delete_produk_action.php?id_produk=<?php echo $data['id_produk']?>" 
